import { NetworkDetails } from "@/libs/types";
...
export const CENNZNET_SIGNER: string = process.env.CENNZNET_SIGNER ?? "//Alice";
...
export const SPENDING_ASSET_ID: string =
	CENNZNET_NETWORK === "azalea" ? "2" : "16001";
